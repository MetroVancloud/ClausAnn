...
<div>
    <div class="sub_title_bar">
        ...
        &nbsp;
        <span>*&nbsp;差值型指标（指标总数：<b id="ruleItemDiffCount" style="color: #bb8e67;">${ruleItemDiffList.size()}</b>）</span>
        <a href="javascript:void(0)" onclick="saveRuleItemDiff()" style="float: right; margin-right: 8px;">保存</a>
        ...
        <div class="col-lg-12">
            <div class="panel-body" style="padding: 0;">
                <table width="100%;" style="font-size: 12px" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody id="ruleItemDiffTable">
                    <c:forEach items="${ruleItemDiffList}" var="entry" varStatus="idxStatus">
                        <tr>
                            ...
                            <td class="operateTd"><a href="javascript:void(0)" onclick="deleteItem(this, 'ruleItemDiffCount')">删除</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
