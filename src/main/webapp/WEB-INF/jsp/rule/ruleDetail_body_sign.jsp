...
<div>
    <div class="sub_title_bar">
        ...
        &nbsp;
        <span>*&nbsp;体征型指标（指标总数：<b id="ruleBodySignCount" style="color: #bb8e67;">${ruleBodySignList.size()}</b>）</span>
        <a href="javascript:void(0)" onclick="saveRuleBodySign()" style="float: right; margin-right: 8px;">保存</a>
        ...
        <div class="col-lg-12">
            <div class="panel-body" style="padding: 0;">
                <table width="100%;" style="font-size: 12px" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody id="ruleBodySignTable">
                    <c:forEach items="${ruleBodySignList}" var="entry" varStatus="idxStatus">
                        <tr>
                            <td class="operateTd">${idxStatus.index + 1}</td>
                            <td style="display: none;">${entry.id}</td>
                            <td><input style="border: none;background: #f9f9f9;" type="text" name="signName" value="${entry.signName}" readonly /></td>
                            ...
                            <td><input style="border: none;background: #f9f9f9;" type="text" name="signUnit" value="${entry.signUnit}" readonly /></td>
                            <td class="operateTd"><a href="javascript:void(0)" onclick="deleteItem(this, 'ruleBodySignCount')">删除</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
